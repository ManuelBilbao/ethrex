...
In contrast, our philosophy is  in simplicity. We strive to write minimal code, prioritize clarity, and simplicity in design. We believe this approach is the best way to build a client that is both fast and resilient. By to, we will be able to iterate fast and explore next-generation features early, either from the Ethereum roadmap or from innovations from the L2s.
